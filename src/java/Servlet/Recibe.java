...
public class Recibe extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Verifica las credenciales (reemplaza esto con tu lógica de autenticación real)
        if (user.equals("1") && pass.equals("1")) {
            // Credenciales correctas, redirige al formulario
            response.sendRedirect("Datos.jsp");
        } else {
            // Credenciales incorrectas, muestra un mensaje de error
            response.getWriter().println("Credenciales incorrectas. Inténtalo de nuevo.");
        }
    }
